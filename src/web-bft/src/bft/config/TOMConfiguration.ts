...
export class TOMConfiguration {
  ...
  hosts: Host[] = [
    {server_id: 0, address: 'localhost', port: 11005},
    {server_id: 1, address: 'localhost', port: 11015},
    {server_id: 2, address: 'localhost', port: 11025},
    {server_id: 3, address: 'localhost', port: 11035}
    /*
    ,
